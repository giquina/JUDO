        ...
        <div className="container mx-auto px-4 py-20 md:py-32 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              >
                <Badge variant="secondary" className="px-3 py-1 text-sm backdrop-blur-sm bg-secondary/80">
                  <QrCode className="w-3 h-3 mr-1" /> QR Check-in
                </Badge>
              </motion.div>
              <motion.div
                animate={{ y: [0, -5, 0] }}
              ...
              >
                <Badge variant="secondary" className="px-3 py-1 text-sm backdrop-blur-sm bg-secondary/80">
                  <Trophy className="w-3 h-3 mr-1" /> Belt Tracking
                </Badge>
              </motion.div>
              <motion.div
                animate={{ y: [0, -5, 0] }}
              ...
              >
                <Badge variant="secondary" className="px-3 py-1 text-sm backdrop-blur-sm bg-secondary/80">
                  <Calendar className="w-3 h-3 mr-1" /> Smart Scheduling
                </Badge>
              </motion.div>
            </motion.div>
