...
const navItems: NavItem[] = [
  ...
  { path: "/coach/classes", label: "Classes", icon: Calendar },
  { path: "/coach/attendance", label: "Attendance", icon: QrCode },
  { path: "/coach/members", label: "Members", icon: Users },
      ...
      <div className="flex items-center justify-between h-16 px-4 border-b border-border">
        <AnimatePresence mode="wait">
          {!isCollapsed && (
            ...
            >
              <span className="font-semibold text-lg text-foreground">Coach Panel</span>
            </motion.div>
          )}
        </AnimatePresence>
